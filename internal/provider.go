...
import (
	...
	"os"
	"regexp"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/consts"
	"github.com/cloudflare/cloudflare-go/v6"
	"github.com/cloudflare/cloudflare-go/v6/option"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/access_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_api_token_permission_groups"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_dns_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_dns_settings_internal_view"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_member"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_permission_group"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_role"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_subscription"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/account_token"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/address_map"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_shield"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_shield_discovery_operation"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_shield_operation"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_shield_operation_schema_validation_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_shield_schema"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_shield_schema_validation_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_token"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/api_token_permission_groups"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/argo_smart_routing"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/argo_tiered_caching"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/authenticated_origin_pulls"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/authenticated_origin_pulls_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/authenticated_origin_pulls_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/bot_management"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/botnet_feed_config_asn"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/byo_ip_prefix"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/calls_sfu_app"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/calls_turn_app"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/certificate_pack"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/cloud_connector_rules"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/cloudforce_one_request"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/cloudforce_one_request_asset"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/cloudforce_one_request_message"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/cloudforce_one_request_priority"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/content_scanning_expression"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/custom_hostname"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/custom_hostname_fallback_origin"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/custom_pages"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/custom_ssl"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/d1_database"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dcv_delegation"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_firewall"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_record"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_zone_transfers_acl"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_zone_transfers_incoming"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_zone_transfers_outgoing"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_zone_transfers_peer"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/dns_zone_transfers_tsig"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_routing_address"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_routing_catch_all"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_routing_dns"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_routing_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_routing_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_security_block_sender"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_security_impersonation_registry"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/email_security_trusted_domains"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/filter"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/firewall_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/healthcheck"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/hostname_tls_setting"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/hyperdrive_config"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/image"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/image_variant"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/ip_ranges"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/keyless_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/leaked_credential_check"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/leaked_credential_check_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/list"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/list_item"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/load_balancer"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/load_balancer_monitor"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/load_balancer_pool"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/logpull_retention"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/logpush_dataset_field"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/logpush_dataset_job"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/logpush_job"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/logpush_ownership_challenge"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_network_monitoring_configuration"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_network_monitoring_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_transit_connector"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_transit_site"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_transit_site_acl"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_transit_site_lan"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_transit_site_wan"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_wan_gre_tunnel"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_wan_ipsec_tunnel"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/magic_wan_static_route"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/managed_transforms"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/mtls_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/notification_policy"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/notification_policy_webhooks"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/observatory_scheduled_test"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/origin_ca_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/page_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/page_shield_connections"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/page_shield_cookies"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/page_shield_policy"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/page_shield_scripts"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/pages_domain"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/pages_project"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/queue"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/queue_consumer"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_bucket"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_bucket_cors"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_bucket_event_notification"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_bucket_lifecycle"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_bucket_lock"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_bucket_sippy"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_custom_domain"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/r2_managed_domain"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/rate_limit"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/regional_hostname"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/regional_tiered_cache"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/registrar_domain"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/resource_group"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/ruleset"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/schema_validation_operation_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/schema_validation_schemas"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/schema_validation_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/snippet"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/snippet_rules"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/snippets"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/spectrum_application"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_audio_track"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_caption_language"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_download"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_key"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_live_input"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_watermark"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/stream_webhook"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/tiered_cache"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/total_tls"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/turnstile_widget"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/url_normalization_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/user"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/user_agent_blocking_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/waiting_room"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/waiting_room_event"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/waiting_room_rules"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/waiting_room_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/web3_hostname"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/web_analytics_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/web_analytics_site"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/worker"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/worker_version"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_cron_trigger"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_custom_domain"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_deployment"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_for_platforms_dispatch_namespace"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_kv"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_kv_namespace"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_route"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_script"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/workers_script_subdomain"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_application"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_custom_page"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_group"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_identity_provider"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_infrastructure_target"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_key_configuration"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_mtls_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_mtls_hostname_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_policy"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_service_token"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_short_lived_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_access_tag"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_custom_profile"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_custom_profile_local_domain_fallback"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_default_profile"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_default_profile_certificates"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_default_profile_local_domain_fallback"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_managed_networks"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_posture_integration"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_posture_rule"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_device_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dex_test"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_custom_entry"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_custom_profile"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_dataset"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_entry"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_integration_entry"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_predefined_entry"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dlp_predefined_profile"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_dns_location"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_app_types"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_categories"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_certificate"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_logging"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_policy"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_proxy_endpoint"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_gateway_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_list"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_organization"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_risk_behavior"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_risk_scoring_integration"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_cloudflared"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_cloudflared_config"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_cloudflared_route"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_cloudflared_token"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_cloudflared_virtual_network"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_warp_connector"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zero_trust_tunnel_warp_connector_token"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_cache_reserve"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_cache_variants"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_dns_settings"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_dnssec"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_hold"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_lockdown"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_setting"
	"github.com/webwarrior-ws/terraform-provider-cloudflare/internal/services/zone_subscription"
